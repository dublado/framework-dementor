...
class canvas {
     ...
     private function dados()
     {
          ...
          if ( is_file( $this->origem ) )
          {
               ...
               if ( !$this->eImagem() )
               {
                    ...
                    error_log( 'Erro: Arquivo '.$this->origem.' não é uma imagem!', E_USER_ERROR );
	            die();
               }
               else
               {
          ...
          else
          {
               ...
               error_log( 'Erro: Arquivo de imagem não encontrado!', E_USER_ERROR );
          }
    ...
    **/
     ...
     **/
     ...
     private function criaImagem()
     {
          switch ( $this->formato )
          {
               ...
               default:
                    ...
                    error_log( 'Arquivo inválido!', E_USER_ERROR );return false;
                    break;
          }
     } // fim criaImagem
      ...
      * @return Object instância atual do objeto, para métodos encadeados
      **/
     public function redimensiona( $nova_largura = 0, $nova_altura = 0, $tipo = '',$zoom=false )
     {
          ...
          switch( $tipo )
          {
               case 'crop':
                    ...
                    break;
               case 'preenchimento':
                    $this->redimensionaPreenchimento($zoom);
                    break;
               default:
      ...
      * @return void
      **/
     private function redimensionaPreenchimento($zoom = true)
     {
          // cria imagem de destino temporária
          $this->img_temp = imagecreatetruecolor( $this->nova_largura, $this->nova_altura );
	...
	// Verifica se é pra gerar thumb exato da imagem com o tamanho proporcional
	// ou thumb em que o preenchimento com a imagem seja inteiro sem sobras no canvas
	if(!$zoom)
	{
		if( $dif_w > $this->nova_largura )
		{
		$dif_w = $this->nova_largura;
		$dif_h = ($this->altura * $this->nova_altura) / $this->largura ;
		}

		if( $dif_h > $this->nova_altura )
		{
		$dif_h = $this->nova_altura;
		$dif_w = ($this->largura * $this->nova_largura) / $this->altura ;
		}
	}
